	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template v-show="logistics">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="商户名称" prop="shangjiahao">
					<el-input v-model="ruleForm.shangjiahao" placeholder="商户名称" clearable  :readonly="ro.shangjiahao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="商户名称" prop="shangjiahao">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="用户角色" prop="role">
					<el-input v-model="ruleForm.role" placeholder="用户角色" clearable  :readonly="ro.role"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="用户角色" prop="role">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../djangot9tw7jz0/upload');
        } else {

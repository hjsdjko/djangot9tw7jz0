<template>
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="产品名称" prop="chanpinmingcheng">
					<el-input v-model="ruleForm.chanpinmingcheng" placeholder="产品名称" clearable  :readonly="ro.chanpinmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="产品名称" prop="chanpinmingcheng">
					<el-input v-model="ruleForm.chanpinmingcheng" placeholder="产品名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="产品类型" prop="chanpinleixing">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="产品类型" prop="chanpinleixing">
					<el-input v-model="ruleForm.chanpinleixing"
						placeholder="产品类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.chanpintupian" label="产品图片" prop="chanpintupian">
					<file-upload
						tip="点击上传产品图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.chanpintupian" label="产品图片" prop="chanpintupian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="储存方式" prop="chucunfangshi">
					<el-input v-model="ruleForm.chucunfangshi" placeholder="储存方式" clearable  :readonly="ro.chucunfangshi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="储存方式" prop="chucunfangshi">
					<el-input v-model="ruleForm.chucunfangshi" placeholder="储存方式" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="包装方式" prop="baozhuangfangshi">
					<el-input v-model="ruleForm.baozhuangfangshi" placeholder="包装方式" clearable  :readonly="ro.baozhuangfangshi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="包装方式" prop="baozhuangfangshi">
					<el-input v-model="ruleForm.baozhuangfangshi" placeholder="包装方式" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="商家号" prop="shangjiahao">
					<el-input v-model="ruleForm.shangjiahao" placeholder="商家号" clearable  :readonly="ro.shangjiahao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="商家号" prop="shangjiahao">
					<el-input v-model="ruleForm.shangjiahao" placeholder="商家号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="商家名称" prop="shangjiamingcheng">
					<el-input v-model="ruleForm.shangjiamingcheng" placeholder="商家名称" clearable  :readonly="ro.shangjiamingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="商家名称" prop="shangjiamingcheng">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="详情描述" prop="xiangqingmiaoshu">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.xiangqingmiaoshu" label="详情描述" prop="xiangqingmiaoshu">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.xiangqingmiaoshu = this.ruleForm.xiangqingmiaoshu.replace(reg,'../../../djangot9tw7jz0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
